...
void test_special() {
    ...
    CASE("sp_[#]"); P("[%#X]", 0);
    SUB();
    CASE("sp_[10.]"); P("[%10.c]", 'a');
    CASE("sp_[10.]"); P_FT("[%10.s]", NULL); P_LINUX("[          ]");
    CASE("sp_[10.]"); P_FT("[%10.s]", "aiueo"); P_LINUX("[          ]");
    CASE("sp_[10.]"); P("[%10.p]", 0);
    CASE("sp_[10.]"); P("[%10.p]", -1);
    CASE("sp_[10.]"); P("[%10.p]", 1);
    CASE("sp_[10.]"); P("[%10.p]", INT_MAX);
    CASE("sp_[10.]"); P("[%10.p]", INT_MIN);
    CASE("sp_[10.]"); P("[%10.p]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.p]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.d]", 0);
    CASE("sp_[10.]"); P("[%10.d]", -1);
    CASE("sp_[10.]"); P("[%10.d]", 1);
    CASE("sp_[10.]"); P("[%10.d]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.d]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.d]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.d]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.i]", 0);
    CASE("sp_[10.]"); P("[%10.i]", -1);
    CASE("sp_[10.]"); P("[%10.i]", 1);
    CASE("sp_[10.]"); P("[%10.i]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.i]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.i]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.i]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.u]", 0);
    CASE("sp_[10.]"); P("[%10.u]", -1);
    CASE("sp_[10.]"); P("[%10.u]", 1);
    CASE("sp_[10.]"); P("[%10.u]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.u]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.u]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.u]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.x]", 0);
    CASE("sp_[10.]"); P("[%10.x]", -1);
    CASE("sp_[10.]"); P("[%10.x]", 1);
    CASE("sp_[10.]"); P("[%10.x]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.x]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.x]", INT_MAX + 1LL);
    CASE("sp_[10.]"); P("[%10.x]", INT_MIN - 1LL);
    CASE("sp_[10.]"); P("[%10.X]", 0);
    CASE("sp_[10.]"); P("[%10.X]", -1);
